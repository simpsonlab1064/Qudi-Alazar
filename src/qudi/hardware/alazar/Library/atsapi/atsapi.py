...
INPUT_RANGE_0_TO_40_MV = 0x31
INPUT_RANGE_0_TO_80_MV = 0x32
INPUT_RANGE_0_TO_100_MV = 0x33
INPUT_RANGE_0_TO_160_MV = 0x34
INPUT_RANGE_0_TO_200_MV = 0x35
INPUT_RANGE_0_TO_250_MV = 0x36
INPUT_RANGE_0_TO_400_MV = 0x37
INPUT_RANGE_0_TO_500_MV = 0x38
INPUT_RANGE_0_TO_800_MV = 0x39
INPUT_RANGE_0_TO_1_V = 0x3A
INPUT_RANGE_0_TO_1600_MV = 0x3B
INPUT_RANGE_0_TO_2_V = 0x3C
INPUT_RANGE_0_TO_2_V_5 = 0x3D
INPUT_RANGE_0_TO_4_V = 0x3E
INPUT_RANGE_0_TO_5_V = 0x3F
INPUT_RANGE_0_TO_8_V = 0x40
INPUT_RANGE_0_TO_10_V = 0x41
INPUT_RANGE_0_TO_16_V = 0x42
INPUT_RANGE_0_TO_20_V = 0x43
INPUT_RANGE_0_TO_80_V = 0x44
INPUT_RANGE_0_TO_32_V = 0x45
INPUT_RANGE_0_TO_MINUS_40_MV = 0x46
INPUT_RANGE_0_TO_MINUS_80_MV = 0x47
INPUT_RANGE_0_TO_MINUS_100_MV = 0x48
INPUT_RANGE_0_TO_MINUS_160_MV = 0x49
INPUT_RANGE_0_TO_MINUS_200_MV = 0x4A
INPUT_RANGE_0_TO_MINUS_250_MV = 0x4B
INPUT_RANGE_0_TO_MINUS_400_MV = 0x4C
INPUT_RANGE_0_TO_MINUS_500_MV = 0x4D
INPUT_RANGE_0_TO_MINUS_800_MV = 0x4E
INPUT_RANGE_0_TO_MINUS_1_V = 0x4F
INPUT_RANGE_0_TO_MINUS_1600_MV = 0x50
INPUT_RANGE_0_TO_MINUS_2_V = 0x51
INPUT_RANGE_0_TO_MINUS_2_V_5 = 0x52
INPUT_RANGE_0_TO_MINUS_4_V = 0x53
INPUT_RANGE_0_TO_MINUS_5_V = 0x54
INPUT_RANGE_0_TO_MINUS_8_V = 0x55
INPUT_RANGE_0_TO_MINUS_10_V = 0x56
INPUT_RANGE_0_TO_MINUS_16_V = 0x57
INPUT_RANGE_0_TO_MINUS_20_V = 0x58
INPUT_RANGE_0_TO_MINUS_80_V = 0x59
INPUT_RANGE_0_TO_MINUS_32_V = 0x60
...
DSP_MODULE_SSK = 0x10002
DSP_MODULE_DIS = 0x10003
...
FFT_OUTPUT_FORMAT_S32_LOG = 0x401
FFT_OUTPUT_FORMAT_S32_PHASE = 0x402
FFT_OUTPUT_FORMAT_S16_REAL = 0x403
FFT_OUTPUT_FORMAT_S16_IMAG = 0x404
FFT_OUTPUT_FORMAT_S16_LOG = 0x405
FFT_OUTPUT_FORMAT_S16_AMP2 = 0x406
FFT_OUTPUT_FORMAT_S16_PHASE = 0x407
FFT_OUTPUT_FORMAT_S8_REAL = 0x408
FFT_OUTPUT_FORMAT_S8_IMAG = 0x409
FFT_OUTPUT_FORMAT_S8_LOG = 0x40A
FFT_OUTPUT_FORMAT_S8_AMP2 = 0x40B
FFT_OUTPUT_FORMAT_S8_PHASE = 0x40C
FFT_OUTPUT_FORMAT_FLOAT_REAL = 0x40D
FFT_OUTPUT_FORMAT_FLOAT_IMAG = 0x40E
FFT_OUTPUT_FORMAT_FLOAT_PHASE = 0x40F
FFT_OUTPUT_FORMAT_S16_AMP2_AND_PHASE = 0x410
FFT_OUTPUT_FORMAT_S16_LOG_AND_PHASE = 0x411
FFT_OUTPUT_FORMAT_S16_REAL_AND_IMAG = 0x412
...
class Board:
    ...
    ats.AlazarGetFPGAVersion.restype = c_uint32
    ats.AlazarGetFPGAVersion.argtypes = [handle_t, POINTER(c_byte), POINTER(c_byte)]
    ats.AlazarGetFPGAVersion.errcheck = returnCodeCheck
    def getFPGAVersion(self):
        major = c_byte(0)
        minor = c_byte(0)
        ats.AlazarGetFPGAVersion(self.handle, byref(major), byref(minor))
        return (major, minor)
    ...
    def setTriggerTimeOut(self, timeout_ticks):

        '''Configures the trigger timeout.'''
        ats.AlazarSetTriggerTimeOut(self.handle, timeout_ticks)
